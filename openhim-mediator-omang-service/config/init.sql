...
CREATE USER immigration IDENTIFIED BY "some-password";
...
--Seeding OMANG Data
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'OLEBILE','false', 'CENTRAL-TUTUME', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2009-06-18', 'YYYY-MM-DD'), '18', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1992-08-27', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2009-06-18', 'YYYY-MM-DD'), 'SURNAME3', '28', 'SGL', TO_TIMESTAMP('2019-05-27', 'YYYY-MM-DD'), 'LIVE', 'Single', '210713925');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'ARABANG', 'false', 'NORTH-EAST', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2015-05-20', 'YYYY-MM-DD'), '19', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1999-05-02', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2015-05-20', 'YYYY-MM-DD'), 'SURNAME1', '28', 'SGL', TO_TIMESTAMP('2025-05-18', 'YYYY-MM-DD'), 'LIVE', 'Single', '237720129');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'EMMANUEL','false', 'CENTRAL-TUTUME', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2011-01-25', 'YYYY-MM-DD'), '18', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1994-11-30', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2011-01-25', 'YYYY-MM-DD'), 'SURNAME5', '28', 'SGL', TO_TIMESTAMP('2020-12-22', 'YYYY-MM-DD'), 'LIVE', 'Single', '249718716');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (TO_TIMESTAMP('2009-06-18', 'YYYY-MM-DD'), 'IPONENG', 'false', 'NORTH-EAST', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2012-10-05', 'YYYY-MM-DD'), '19', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1995-01-29', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2012-10-05', 'YYYY-MM-DD'), 'SURNAME2', '28', 'SGL', TO_TIMESTAMP('2022-10-04', 'YYYY-MM-DD'), 'DEAD', 'Single', '255717018');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'CAROLINE', 'false', 'FRANCISTOW', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2017-01-13', 'YYYY-MM-DD'), '02', 'F', NULL, 'CITZ', NULL, TO_TIMESTAMP('1987-01-13', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2017-01-13', 'YYYY-MM-DD'), 'SURNAME10', '28', 'SGL', TO_TIMESTAMP('2027-01-10', 'YYYY-MM-DD'), 'LIVE', 'Single', '258630218');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'JAMES', 'false', 'NORTH-EAST', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2011-02-17', 'YYYY-MM-DD'), '19', 'F', NULL, 'CITZ', NULL, TO_TIMESTAMP('1993-01-21', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2011-02-17', 'YYYY-MM-DD'), 'SURNAME4', '28', 'MAR', TO_TIMESTAMP('2021-02-16', 'YYYY-MM-DD'), 'LIVE', 'Married', '259575714');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'OLORATO', 'false', 'CENTRAL-SEROWE', 'BOOK-KEEPERS, CASHIERS AND RELATED WORKERS', 'FRANCISTOW', TO_TIMESTAMP('2016-04-26', 'YYYY-MM-DD'), '14', 'F', NULL, 'CITZ', NULL, TO_TIMESTAMP('1988-09-16', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2016-04-26', 'YYYY-MM-DD'), 'SURNAME7', '33', 'SGL', TO_TIMESTAMP('2026-04-25', 'YYYY-MM-DD'), 'LIVE', 'Single', '264522418');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'THATO', 'false', 'CENTRAL-TUTUME', 'TRANSPORT CONDUCTORS', 'FRANCISTOW', TO_TIMESTAMP('2016-10-24', 'YYYY-MM-DD'), '18', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1988-03-14', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2016-10-24', 'YYYY-MM-DD'), 'SURNAME8', '36', 'SGL', TO_TIMESTAMP('2026-10-18', 'YYYY-MM-DD'), 'LIVE', 'Single', '272118515');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'MONTY', 'false', 'NORTH-EAST', 'NOT IN THE LABOUR FORCE (STUDENT)', 'FRANCISTOW', TO_TIMESTAMP('2009-08-12', 'YYYY-MM-DD'), '19', 'M', NULL, 'CITZ', NULL, TO_TIMESTAMP('1990-07-13', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2009-08-12', 'YYYY-MM-DD'), 'SURNAME6', '28', 'SGL', TO_TIMESTAMP('2017-01-05', 'YYYY-MM-DD'), 'LIVE', 'Single', '286817514');
INSERT INTO omang.OMANG_CITIZEN (DECEASED_DTE, FIRST_NME, BIRTH_DTE_UNKNOWN, DISTRICT_NME, OCCUPATION_DESCR, BIRTH_PLACE_NME, CHANGE_DTE, DISTRICT_CDE, SEX, SPOUSE_NME, CITIZEN_STATUS_CDE, DEATH_CERT_NO, BIRTH_DTE, DECEASED_DTE_UNKNOWN, CITIZEN_STATUS_DTE, SURNME, OCCUPATION_CDE, MARITAL_STATUS_CDE, EXPIRY_DTE, PERSON_STATUS, MARITAL_STATUS_DESCR, ID_NO) VALUES (NULL, 'KA', 'false', 'NORTH-EAST', 'WORKERS REPORTING UNIDENTIFIABLE OCCUPATIONS', 'FRANCISTOW', TO_TIMESTAMP('2015-09-22', 'YYYY-MM-DD'), '19', 'F', NULL, 'CITZ', NULL, TO_TIMESTAMP('1988-09-11', 'YYYY-MM-DD'), NULL, TO_TIMESTAMP('2015-09-22', 'YYYY-MM-DD'), 'SURNAME9', '25', 'SGL', TO_TIMESTAMP('2025-09-21', 'YYYY-MM-DD'), 'LIVE', 'Single', '373823112');
...
CREATE TABLE immigration.V_MOH(
	PASSPORT_NO VARCHAR2(50) NOT NULL, 
	PASSP_ISSUE_DATE timestamp NULL,
	PASSP_EXPIRY_DATE timestamp NULL,
	SURNAME VARCHAR2(50) NOT NULL,
	FIRST_NAME VARCHAR2(50) NOT NULL,
	MIDDLE_NAME VARCHAR2(50) NULL, 
	CITIZENSHIP VARCHAR2(50) NOT NULL, 
	CITIZENSHIP_NAME VARCHAR2(50) NOT NULL,
	GENDER VARCHAR2(50) NOT NULL,
	BIRTH_DATE timestamp NULL,
	BIRTH_COUNTRY_CODE VARCHAR2(50) NOT NULL,
	BIRTH_COUNTRY_NAME VARCHAR2(50) NOT NULL, 
	MARITAL_STATUS_CODE VARCHAR2(50) NOT NULL,
	MARITAL_STATUS_NAME VARCHAR2(50) NOT NULL,
	DATE_OF_ENTRY timestamp NULL,
	ENTRY_PLACE_CODE VARCHAR2(50) NOT NULL,
	ENTRY_PLACE_NAME VARCHAR2(200) NOT NULL,
	SPOUSE_FIRST_NAME VARCHAR2(50) NULL,
	SPOUSE_SURNAME VARCHAR2(50) NULL			
);
...
VALUES
	(
		'987654321', TO_TIMESTAMP('2018-03-25', 'YYYY-MM-DD'), TO_TIMESTAMP('2028-03-25', 'YYYY-MM-DD'), 'LEE', 'JAE', 'SUNG', 'SOUTH KOREAN', 'SOUTH KOREA', 'Male', TO_TIMESTAMP('1983-07-18', 'YYYY-MM-DD'), 'KR', 'SOUTH KOREA', 'DIV', 'Divorced', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'GMP', 'Gimpo International Airport', 'JI-YEON', 'LEE');
--Seeding Immigrations
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('650051651', TO_TIMESTAMP('2020-06-18', 'YYYY-MM-DD'), TO_TIMESTAMP('2030-06-18', 'YYYY-MM-DD'), 'DAVE', 'MAU', 'KEN', 'UGANDAN', 'UGANDA', 'Male', TO_TIMESTAMP('2005-06-18', 'YYYY-MM-DD'), 'UG', 'UGANDA', 'SGL', 'Single', TO_TIMESTAMP('2024-01-11', 'YYYY-MM-DD'), 'SSKIA', 'Sir Seretse Khama International Airport in Gaborone', 'MARIA', 'ANTOINETTE');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('982454321', TO_TIMESTAMP('2018-03-25', 'YYYY-MM-DD'), TO_TIMESTAMP('2028-03-25', 'YYYY-MM-DD'), 'SMITH', 'JOHN', 'ALLEN', 'BRITISH', 'UNITED KINGDOM', 'Male', TO_TIMESTAMP('1980-02-15', 'YYYY-MM-DD'), 'GB', 'UNITED KINGDOM', 'MARR', 'Married', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'JFK', 'John F. Kennedy International Airport', 'EMMA', 'SMITH');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('123456789', TO_TIMESTAMP('2015-08-10', 'YYYY-MM-DD'), TO_TIMESTAMP('2025-08-10', 'YYYY-MM-DD'), 'WANG', 'LI', 'XIU', 'CHINESE', 'CHINA', 'Female', TO_TIMESTAMP('1990-07-20', 'YYYY-MM-DD'), 'CN', 'CHINA', 'SGL', 'Single', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'PEK', 'Beijing Capital International Airport', 'ZHANG', 'WEI');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('237654321', TO_TIMESTAMP('2018-03-25', 'YYYY-MM-DD'), TO_TIMESTAMP('2028-03-25', 'YYYY-MM-DD'), 'DIAZ', 'CARLOS', 'ANTONIO', 'MEXICAN', 'MEXICO', 'Male', TO_TIMESTAMP('1985-06-08', 'YYYY-MM-DD'), 'MX', 'MEXICO', 'DIV', 'Divorced', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'MEX', 'Mexico City International Airport', 'ISABELLA', 'DIAZ');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('111222333', TO_TIMESTAMP('2017-02-08', 'YYYY-MM-DD'), TO_TIMESTAMP('2027-02-08', 'YYYY-MM-DD'), 'KIM', 'MIN', 'HO', 'SOUTH KOREAN', 'SOUTH KOREA', 'Male', TO_TIMESTAMP('1988-12-01', 'YYYY-MM-DD'), 'KR', 'SOUTH KOREA', 'MARR', 'Married', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'ICN', 'Incheon International Airport', 'HANNAH', 'KIM');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('444555666', TO_TIMESTAMP('2016-05-15', 'YYYY-MM-DD'), TO_TIMESTAMP('2026-05-15', 'YYYY-MM-DD'), 'GARCIA', 'MIGUEL', 'ANGEL', 'SPANISH', 'SPAIN', 'Male', TO_TIMESTAMP('1992-09-22', 'YYYY-MM-DD'), 'ES', 'SPAIN', 'SGL', 'Single', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'MAD', 'Adolfo Suárez Madrid–Barajas Airport', 'SOFIA', 'GARCIA');
INSERT INTO immigration.V_MOH (PASSPORT_NO, PASSP_ISSUE_DATE, PASSP_EXPIRY_DATE, SURNAME, FIRST_NAME, MIDDLE_NAME, CITIZENSHIP, CITIZENSHIP_NAME, GENDER, BIRTH_DATE, BIRTH_COUNTRY_CODE, BIRTH_COUNTRY_NAME, MARITAL_STATUS_CODE, MARITAL_STATUS_NAME, DATE_OF_ENTRY, ENTRY_PLACE_CODE, ENTRY_PLACE_NAME, SPOUSE_FIRST_NAME, SPOUSE_SURNAME) VALUES ('777888999', TO_TIMESTAMP('2019-08-30', 'YYYY-MM-DD'), TO_TIMESTAMP('2029-08-30', 'YYYY-MM-DD'), 'NGUYEN', 'LINH', 'THI', 'VIETNAMESE', 'VIETNAM', 'Female', TO_TIMESTAMP('1995-04-10', 'YYYY-MM-DD'), 'VN', 'VIETNAM', 'SGL', 'Single', TO_TIMESTAMP('2024-01-15', 'YYYY-MM-DD'), 'SGN', 'Tan Son Nhat International Airport', 'QUANG', 'TRAN');
